        ...
        <div className="hidden lg:block px-8 py-4">
          <div className="flex items-center justify-between w-full relative">
            ...
            <div className="flex gap-4 items-center absolute right-0">
              ...
              <div className='text-red-500 font-semibold rounded-full w-6 h-6 flex items-center justify-center bg-gray-300 cursor-pointer -ml-4 shadow-xl'>{item.length}</div>
